...
var Term = Datatype.Term,
    ...
    DEFAULTGRAPH = new Datatype.DefaultGraph();
...
N3Writer.prototype = {
  ...
  _writeTripleTerms: function (subject, predicate, object, graph, done) {
    this._writeTriple(Term.toId(subject), predicate, object, graph, done);
  },
  ...
  _encodeLiteral: function (literal) {
    ...
    else if (literal.datatype.value !== Literal.STRING)
      return '"' + value + '"^^' + this._encodeIriOrBlankNode(literal.datatype.value);
    else
      return '"' + value + '"';
  },
  ...
  _encodePredicate: function (predicate) {
    return predicate.value === RDF_TYPE ? 'a' : this._encodeIriOrBlankNode(Term.toId(predicate));
  },

  // ### `_encodeObject` represents an object
  _encodeObject: function (object) {
    if (object.termType !== 'Literal')
      return this._encodeIriOrBlankNode(Term.toId(object));
    else
  ...
  addTriple: function (subject, predicate, object, graph, done) {
    ...
    // The optional `graph` parameter was not provided
      ...
      this._writeTripleTerms(subject, predicate, object, DEFAULTGRAPH, graph);
    // The `graph` parameter was provided
    else
      this._writeTripleTerms(subject, predicate, object, graph || DEFAULTGRAPH, done);
  },
