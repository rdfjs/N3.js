...
N3Writer.prototype = {
  ...
  _encodeLiteral: function (literal) {
    ...
    if (literal.language)
      ...
      return '"' + value + '"^^' + this._encodeIriOrBlankNode(literal.datatype);
    else
      return '"' + value + '"';
  },
  ...
  _encodePredicate: function (predicate) {
    return predicate.value === RDF_TYPE ? 'a' : this._encodeIriOrBlankNode(predicate);
  },
  ...
  addTriple: function (subject, predicate, object, graph, done) {
    ...
    // The optional `graph` parameter was not provided
      ...
      this._writeTriple(subject, predicate, object, DEFAULTGRAPH, graph);
    // The `graph` parameter was provided
    else
      this._writeTriple(subject, predicate, object, graph || DEFAULTGRAPH, done);
  },
