...
N3Store.prototype = {
        ...
        for (var value1 in index1) {
          ...
          if (index2 = index1[value1]) {
            ...
            for (var l = values.length - 1; l >= 0; l--) {
              var result = quad(null, null, null, fromId(graph));
              result[name0] = fromId(entity0);
              result[name1] = fromId(entity1);
              result[name2] = fromId(entityKeys[values[l]]);
              if (array)
                array.push(result);
  ...
  createBlankNode: function (suggestedName) {
    ...
    return blankNode(name.substr(2));
  },
};
