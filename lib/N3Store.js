...
N3Store.prototype = {
  ...
  // ### `_someInIndex` traverses a three-layered index like `_findInIndex`,
  // but returns true as soon as  `callback` matches a triple; false otherwise.
  _someInIndex: function (index0, key0, key1, key2, name0, name1, name2, graph, callback) {
