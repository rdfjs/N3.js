...
N3Store.prototype = {
  ...
  forSubjectsByIRI: function (callback, predicate, object, graph) {
    var ids = this._ids, graphs = {}, graphContents, predicateId, objectId;
      ...
      if (graphContents = graphs[graph]) {
        ...
        if (predicateId) {
          if (objectId)
            ...
            this._loopBy2Keys(graphContents.predicates, predicateId, objectId, callback);
          else
            // If only predicate is given, the SPO index is best.
            // Loop s, lookup p.
            this._loopByKey1(graphContents.subjects, predicateId, callback);
        }
        else if (objectId)
          // If only object is given, the OSP index is best.
          // Lookup o, loop s.
          this._loopByKey0(graphContents.objects, objectId, callback);
        else
          // If no params given, iterate all the subjects
          this._loop(graphContents.subjects, callback);
      }
    }
  },
  ...
  forPredicatesByIRI: function (callback, subject, object, graph) {
    var ids = this._ids, graphs = {}, graphContents, subjectId, objectId;
    callback = this._uniqueEntities(callback);
      ...
      if (graphContents = graphs[graph]) {
        ...
        if (subjectId) {
          if (objectId)
            ...
            this._loopBy2Keys(graphContents.objects, objectId, subjectId, callback);
          else
            // If only subject is given, the SPO index is best.
            // lookup s, loop p.
            this._loopByKey0(graphContents.subjects, subjectId, callback);
        }
        else if (objectId)
          // If only object is given, the POS index is best.
          // Loop p, lookup o.
          this._loopByKey1(graphContents.predicates, objectId, callback);
        else
          // If no params given, iterate all the predicates.
          this._loop(graphContents.predicates, callback);
      }
    }
  },
  ...
  forObjectsByIRI: function (callback, subject, predicate, graph) {
    var ids = this._ids, graphs = {}, graphContents, subjectId, predicateId;
    callback = this._uniqueEntities(callback);
      ...
      if (graphContents = graphs[graph]) {
        ...
        if (subjectId) {
          if (predicateId)
            ...
            this._loopBy2Keys(graphContents.subjects, subjectId, predicateId, callback);
          else
            // If only subject is given, the OSP index is best.
            // loop o, lookup s.
            this._loopByKey1(graphContents.objects, subjectId, callback);
        }
        else if (predicateId)
          // If only predicate is given, the POS index is best.
          // Looukp p, loop o.
          this._loopByKey0(graphContents.predicates, predicateId, callback);
        else
          // If no params given, iterate all the objects.
          this._loop(graphContents.objects, callback);
      }
    }
  },
