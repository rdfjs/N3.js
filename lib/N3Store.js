...
//TEST----------------------------------------------------------------------------------------------------
	...
	removeTriple: function(context, triple){
		context = context || this.defaultContext;
		var contextItem = this._contexts[context];
		if(!contextItem)
			return false;
		this._removeFromIndex(contextItem.subjects, triple.subject, triple.predicate, triple.object);
		this._removeFromIndex(contextItem.predicates, triple.predicate, triple.object, triple.subject);
		this._removeFromIndex(contextItem.objects, triple.object, triple.subject, triple.predicate);
		return true;
	},
