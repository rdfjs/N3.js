...
N3Parser.prototype = {
  ...
  _readSubject: function (token) {
    ...
    case '[':
      ...
      this._contextStack.push({
        type: 'blank', graph: this._graph, inverse: this._inversePredicate,
        subject: this._subject, predicate: null, object: null,
      });
    ...
    case '(':
      // Start a new list
      this._contextStack.push({
        type: 'list', graph: this._graph, inverse: this._inversePredicate,
        subject: RDF_NIL, predicate: null, object: null,
      });
      this._subject = null;
      this._inversePredicate = false;
    ...
    case '{':
      ...
      this._contextStack.push({
        type: 'formula', graph: this._graph, inverse: this._inversePredicate,
        subject: this._graph = '_:b' + blankNodeCount++, predicate: null, object: null,
      });
      this._inversePredicate = false;
      return this._readSubject;
    case '}':
  ...
  _readObject: function (token) {
    ...
    case '[':
      ...
      this._contextStack.push({
        type: 'blank', graph: this._graph, inverse: this._inversePredicate,
        subject: this._subject, predicate: this._predicate, object: blank,
      });
      this._subject = blank;
      this._inversePredicate = false;
      return this._readBlankNodeHead;
    case '(':
      ...
      this._contextStack.push({
        type: 'list', graph: this._graph, inverse: this._inversePredicate,
        subject: this._subject, predicate: this._predicate, object: RDF_NIL,
      });
      this._subject = null;
      this._inversePredicate = false;
      return this._readListItem;
    case '{':
      ...
      this._contextStack.push({
        type: 'formula', graph: this._graph, inverse: this._inversePredicate,
        subject: this._subject, predicate: this._predicate,
        object: this._graph = '_:b' + blankNodeCount++,
      });
      this._inversePredicate = false;
      return this._readSubject;
    default:
  ...
  _readListItem: function (token) {
    ...
    case '[':
      ...
      stack.push({
        type: 'blank', graph: this._graph, inverse: this._inversePredicate,
        subject: itemHead, predicate: RDF_FIRST, object: item,
      });
      this._subject = item;
      this._inversePredicate = false;
    ...
    case '(':
      ...
      stack.push({
        type: 'list', graph: this._graph, inverse: this._inversePredicate,
        subject: itemHead, predicate: RDF_FIRST, object: RDF_NIL,
      });
      this._subject = null;
      this._inversePredicate = false;
    ...
    case ')':
      ...
      if (stack.length !== 0 && stack[stack.length - 1].type === 'list')
        this._callback(null, { subject:   context.subject,
                               ...
                               graph:     this._graph || '' });
      // Restore the parent context's subject.
      this._subject = context.subject;
      this._graph = context.graph;
      this._inversePredicate = context.inverse;
      ...
      // The list was in the parent context's object.
        ...
        // Restore the parent context's predicate and object as well.
        this._predicate = context.predicate;
        this._object = context.object;
  ...
  _readFormulaTail: function (token) {
    ...
    if (context.object === null)
      return this._readPredicate;
    // If the formula was the object, restore previous context and read punctuation.
    else {
      this._predicate = context.predicate;
      this._object = context.object;
      return this._getTripleEndReader();
