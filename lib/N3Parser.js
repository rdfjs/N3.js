...
var RDF_NIL     = namedNode(namespaces.rdf.nil),
    RDF_FIRST   = namedNode(namespaces.rdf.first),
    RDF_REST    = namedNode(namespaces.rdf.rest),
    N3_FORSOME  = namedNode(namespaces.r.forSome),
    N3_FORALL   = namedNode(namespaces.r.forAll),
    ABBREVIATIONS = {
