...
N3Parser.prototype = {
  ...
  _readListItem: function (token) {
    ...
    if (prevList === null) {
      ...
      this._callback(null, { subject: prevList, predicate: RDF_REST, object: list,
                             graph: this._graph || '' });
    }
    ...
    if (item !== null) {
      ...
      // Output the item
      this._callback(null, { subject: list, predicate: RDF_FIRST, object: item,
                             graph: this._graph || '' });
    }
    return next;
  },
