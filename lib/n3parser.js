...
N3Parser.prototype = {
  ...
  _readSubject: function (token) {
    ...
    case 'liststart':
      // Start a new list
      this._tripleStack.push({ subject: RDF_NIL, predicate: null, object: null });
      this._subject = null;
  ...
  _readObject: function (token) {
    ...
    case 'liststart':
      // Start a new list
      this._tripleStack.push({ subject: this._subject, predicate: this._predicate, object: RDF_NIL });
      this._subject = null;
      return this._readListItem;
    default:
  ...
  _readListItem: function (token) {
    var item = null,                  // The actual list item.
        ...
        parentTriple,                 // The triple containing the current list.
    ...
    case 'literal':
      ...
      break;
    case 'listend':
      // Restore the previous triple
      parentTriple = this._tripleStack.pop();
      this._subject = parentTriple.subject;
      // Was the list in the subject?
    ...
    if (prevItemHead === null) {
      // Set the list head in the parent triple.
      parentTriple = this._tripleStack[this._tripleStack.length - 1];
