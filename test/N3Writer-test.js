...
describe('Writer', () => {
  ...
  describe('A Writer instance', () => {
    ...
    testRelativizes({ baseIRI: 'http://example.org/foo/bar/baz/?query#fragment', absoluteIris: true },
      { input: 'http://example.org/',                                expected: '/' },
      { input: 'http://example.org/?',                               expected: '/?' },
      { input: 'http://example.org/#',                               expected: '/#' },
      { input: 'http://example.org/?query',                          expected: '/?query' },
    ...
    function testRelativizes(baseIRI, ...cases) {
      let absoluteIris = false;
      if (typeof baseIRI === 'object') {
        absoluteIris = baseIRI.absoluteIris;
      ...
      describe(`baseIRI ${baseIRI}`, () => {
        ...
        for (const { input, expected } of cases) {
          const writer = new Writer({ baseIRI, absoluteIris });
